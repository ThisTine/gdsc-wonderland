...
function App() {
    ...
    return (
        ...
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
            ...
            <ModalContent >
                ...
                <ModalBody>
                    ...
                    <HStack>
                        <Button colorScheme="facebook" as={"a"} ><Link href={"https://www.facebook.com/gdsc.kmutt"} target={"_blank"} >Facebook</Link></Button>
                        <Button colorScheme="pink" as={"a"} ><Link href={"https://www.instagram.com/gdsc.kmutt"} target={"_blank"} >Instagram</Link></Button>
        ...
        <Box color={"white"} minW={"100vw"} backdropFilter={"blur(10px)"} bgImage={bg} backgroundSize={"cover"} minH={"100vh"}>
            <NavBar/>
            <Center>
                <Container maxW={"container.xl"}>
                    {hashedToken ? <Game token={hashedToken}/> : token?<Heading textAlign={"center"}>Loading</Heading> : <Heading textAlign={"center"}>Token not found, please check the link from google form</Heading>}
                </Container>
            </Center>
